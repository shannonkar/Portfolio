		 ...
		 <h2>Projects</h2> <span></span>
	        <div className="project-section">
	         ...
	         <div className="content">
	                ...
	                <div className="project_footer">
						...
						<p>Tech Stack: HTML5,CSS, React</p>
	            ...
	            <div className="content">
	                ...
	                <div className="project_footer">
	                    ...
	                    <p>Designed and implemented a website that generates song suggestions based on a user’s
							mood.</p>
						<p> Tech Stack: HTML5, CSS, React, Node.js</p>
	                    <div className="project_links"> 
            ...
            <div className="content">
	                ...
	                <div className="project_footer">
	                   ...
	                   <p>Tech Stack: HTML5, CSS, React, Redux </p>
	                    <div className="project_links"> 
                ...
                <div className="content">
	                ...
	                <div className="project_footer">
	                    ...
	                    <p>Tech Stack: HTML5, CSS, React, Node.js, PostgreSQL</p>
	                   <div className="project_links"> 
